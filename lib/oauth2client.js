 ...
 * @param {string} api_version the name of the oauth version if null is not set.
 */
function OAuth2Client(callContext, authority, api_version) {
...
OAuth2Client.prototype._createTokenUrl = function () {
  ...
  var parameters = {};
  if (this._api_version !== null) {
    parameters[OAuth2Parameters.AAD_API_VERSION] = this._api_version;
  }
